...
function App() {
  ...
  // 아주 편함
  // 저 prefetchQuery의 결과 값을 어떻게 사용하는지는 nextJs에서 살펴보기
  const prefetchQueryClient = new QueryClient();

  // 형태 : queryClient.prefetchQuery(queryKey, Promise return function);
  ...
  // 간단하게 해당 쿼리 키에 해당 하는 쿼리를 비우고 다시 refetch 하는거(최신 값으로 다시 받아오기)
